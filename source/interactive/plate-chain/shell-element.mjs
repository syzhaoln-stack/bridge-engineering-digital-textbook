...
export function shellLocalFrame(nodes, planarityTolerance = 1e-5) {
...
export function q4Shape(xi, eta) {
  return {
    N: new Float64Array([
      0.25 * (1 - xi) * (1 - eta),
      0.25 * (1 + xi) * (1 - eta),
...
export function q4Geometry(localXY, xi, eta) {
 ...
 */
export function shellStrainMatrices(geometry) {
 ...
 */
export function mitc4ShearMatrix(localXY, xi, eta) {
...
export function transformVector(T, vector) {
...
export function transformVectorTranspose(T, vector) {
  const result = new Float64Array(T.length);
  for (let i = 0; i < T.length; i++) {
...
export function shell4Stiffness(nodes, material) {
...
export function shell4PressureLoad(nodes, pressure) {
...
export function mapPointToShell4(nodes, point, tolerance = 1e-7) {
  const frame = shellLocalFrame(nodes);
...
export function shell4PointLoad(nodes, point, force) {
...
export function shell4Response(nodes, material, uGlobal) {
...
export function shell4ResponseFromElement(element, material, uGlobal) {
...
export function assembleShellModel(model) {
...
export function applyNodalLoads(F, loads = []) {
...
export function constrainedDofs(supports = []) {
  const fixed = new Set();
...
export function factorConstrainedSystem(K, fixedDofs, pivotTolerance = 1e-13) {
...
export function solveFactoredSystem(factor, F) {
...
export function elementDisplacements(U, dofs) {
